...
>
> *comment-text-item* → Any Unicode scalar value except U+000A または U+000D
>
>
>
...
>
> *multiline-comment-text-item* → Any Unicode scalar value except  **`/*`** または  **`*/`**
...
> *balanced-token* → **`{`** *balanced-tokens*_?_ **`}`**
>
> *balanced-token* → Any identifier, keyword, literal, または operator
>
> *balanced-token* → Any punctuation except  **`(`**,  **`)`**,  **`[`**,  **`]`**,  **`{`**, または  **`}`**
