...
## [Mutability of Collections\(コレクションの可変性\)](collection-types.md) <a id="mutability-of-collections"></a>
...
## [Arrays\(配列\)](collection-types.md) <a id="arrays"></a>
...
### [Array Type Shorthand Syntax\(配列型の省略構文\)](collection-types.md) <a id="array-type-shorthand-syntax"></a>
...
### [Creating an Array with a Default Value\(デフォルト値を使った配列の作成\)](collection-types.md) <a id="creating-an-array-with-a-default-value"></a>
...
### [Accessing and Modifying an Array\(配列へのアクセスと変更\)](collection-types.md) <a id="accessing-and-modifying-an-array"></a>
...
### [Hash Values for Set Types\(セット型のハッシュ値\)](collection-types.md) <a id="hash-values-for-set-types"></a>
...
## [Dictionaries\(辞書\)](collection-types.md) <a id="dictionaries"></a>
...
### [Dictionary Type Shorthand Syntax\(辞書型の省略構文\)](collection-types.md) <a id="dictionary-type-shorthand-syntax"></a>
...
### [Accessing and Modifying a Dictionary\(辞書へのアクセスと変更\)](collection-types.md) <a id="accessing-and-modifying-a-dictionary"></a>
