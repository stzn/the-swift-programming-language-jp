...
> NOTE  
> 文字列補間で使用できるオブションは[String Interpolation\(文字列補間\)](../language-guide-gaido/strings-and-characters#string-interpolation)に記載しています
