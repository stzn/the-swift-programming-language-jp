...
* `1.25e2` は 1.25 x 10<sup>2</sup> または `125.0` と等しい
* `1.25e-2` は 1.25 x 10<sup>-2</sup> または `0.0125` と等しい

`p`\(`exp`\)を持つ 16 進数では、元の値に 2 の指数\(`2exp`\)を掛けます。

* `0xFp2` は 15 x 2<sup>2</sup> または `60.0` と等しい
* `0xFp-2` は 15 x 2<sup>-2</sup> または `3.75` と等しい
