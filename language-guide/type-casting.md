...
[Checking for Protocol Conformance\(プロトコル準拠チェック\)](../language-guide/protocols#checking-for-protocol-conformance)で説明されているように、型キャストを使用して、型がプロトコルに準拠しているかどうかを確認することもできます。
