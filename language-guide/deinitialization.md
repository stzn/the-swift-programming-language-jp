...
クラスのインスタンスが解放される直前に、*デイニシャライザ*が呼び出されます。`init` キーワードを使用してイニシャライザを作成する方法と同様に、`deinit` キーワードを使用してデイニシャライザを作成します。デイニシャライザは、クラス型でのみ使用できます。
...
## Deinitializers in Action\(デイニシャライザの挙動\)
