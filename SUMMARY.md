...
* [Strings and Characters](language-guide/strings-and-characters.md)
...
* [Enumerations](language-guide/enumerations.md)
* [Structures and Classes](language-guide/structures-and-classes.md)
* [Properties](language-guide/properties.md)
* [Methods](language-guide/methods.md)
* [Subscripts](language-guide/subscripts.md)
* [Inheritance](language-guide/inheritance.md)
* [Initialization](language-guide/initialization.md)
* [Deinitialization](language-guide/deinitialization.md)
* [Optional Chaining](language-guide/optional-chaining.md)
* [Error Handling](language-guide/error-handling.md)
* [Type Casting](language-guide/type-casting.md)
* [Nested Types](language-guide/nested-types.md)
* [Extensions](language-guide/extensions.md)
* [Protocols](language-guide/protocols.md)
...
* [Lexical Structure](language-reference/lexical-structure.md)
...
* [Declarations](language-reference/declarations.md)
* [Attributes](language-reference/attributes.md)
* [Patterns](language-reference/patterns.md)
* [Generic Parameters and Arguments](language-reference/generic-parameters-and-arguments.md)
* [Summary of the Grammar](language-reference/summary-of-the-grammar.md)
