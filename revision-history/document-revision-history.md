...
* [Control Flow](./../language-guide/control-flow.md)の章の[Checking API Availability](./../language-guide/control-flow.md#checking-API-availabilityAPI使用可能性チェック)セクションと、[Statements](./../language-reference/statements.md)の章の[Availability Condition](./../language-reference/statements.md#availability-conditionAvailability条件)セクションに、API 可用性チェックについての情報を追加しました
